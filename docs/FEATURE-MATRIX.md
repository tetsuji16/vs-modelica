...
| OMC             | ZMQ interactive session, scripting codec, capability probe           | 1     | not started | —                                                          |
| OMC             | load/check/class outline, Problems diagnostics                       | 1     | not started | —                                                          |
| Language        | Modelica grammar and language configuration                          | 1     | not started | —                                                          |
